...
class UsersController extends AdminController
{
    ...
    {
        $content_header =  'Новый пользователь';
        ...
        $this->content = view(env('THEME').'.admin.users_create_content')->with(['roles'=>$roles, 'content_header'=>$content_header])->render();
    ...
    {
       $content_header =  'Редактирование пользователя - '. $user->name;
        ...
        $this->content = view(env('THEME').'.admin.users_create_content')->with(['roles'=>$roles,'user'=>$user,'content_header'=>$content_header])->render();
